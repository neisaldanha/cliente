...
<section>
    ...
    {{ Form::model( ['method' => 'POST','route'=>'cad-cliente.store', 'id' => 'cliente', 'class' => 'cadastro', 'files' => true]) }}
        ...
        <div class="col-12">
            <button type="submit" class="btn btn-secondary my-2 mr-1" id="salvar" title="Salvar"><i class="fas fa-save"></i></button>
    ...
    <!-- Informações Gerais -->
        ...
        <div class=" col-sm">
          <div  class="">
            ...
            {!! Form::select('TIPO',['F'=>'Fisica','J'=>'Juridica'], null,array('style'=>'width:30%; height: 30px;', 'class' => 'form-control ', 'autocomplete' => 'off')) !!}
          </div>
        </div>
        ...
        <div class="row" id="fisica">
            <div class="form-group col-md-4">
                ...
                {!! Form::text('CPF', null, array('id'=>'CPF', 'class' => 'form-control ', 'placeholder' => 'Somente Nº', 'autocomplete' => 'off')) !!}
            </div>
            <div class="form-group col-md-6">
                {!! Form::label('NOME', 'Nome', ['class' => 'fw-5 mb-1']) !!}
                {!! Form::text('NOME', null, array( 'class' => 'form-control', 'placeholder' => 'Nome completo', 'autocomplete' => 'off')) !!}
            </div>
            <div class="form-group col-md-4">
                {!! Form::label('DT_NASCIMENTO', 'Nascimento', ['class' => 'fw-5 mb-1']) !!}
                {!! Form::date('DT_NASCIMENTO', null, array('class' => 'form-control', 'placeholder' => 'somente numeros', 'autocomplete' => 'off')) !!}
            </div>
            <div class="form-group col-md-6">
